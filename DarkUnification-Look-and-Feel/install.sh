...
cp -r ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/config/* ~/.config
cp -r ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/themes/* ~/.themes
