...
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/config/* ~/.config
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/themes/* ~/.themes
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/color-schemes ~/.local/share/
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/icons ~/.local/share/
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/plasma ~/.local/share/
...
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/.config ~/
cp -rv ~/DarkUnification-Look-and-Feel-master/DarkUnification-Look-and-Feel/.themes ~/
